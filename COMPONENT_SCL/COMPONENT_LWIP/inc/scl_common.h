 ...
 */
#define SCL_LINK_MTU            (SCL_PAYLOAD_MTU + SCL_PHYSICAL_HEADER)
...
typedef enum {
    ...
    SCL_RX_EVENT_CALLBACK        = 5       /**< Get the wifi event callback*/
} scl_ipc_rx_t;
 ...
 *
 *  The connection status specifies if the device is connected to WiFi or not
 */
typedef enum scl_nsapi_connection_status {
    SCL_NSAPI_STATUS_LOCAL_UP           = 0,        /*!< local IP address set */
    SCL_NSAPI_STATUS_GLOBAL_UP          = 1,        /*!< global IP address set */
    SCL_NSAPI_STATUS_DISCONNECTED       = 2,        /*!< no connection to network */
    SCL_NSAPI_STATUS_CONNECTING         = 3,        /*!< connecting to network */
    SCL_NSAPI_STATUS_ERROR_UNSUPPORTED  = 9999
} scl_nsapi_connection_status_t;
 ...
 */
typedef enum scl_nsapi_security {
    SCL_NSAPI_SECURITY_NONE         = 0x0,      /*!< open access point */
    SCL_NSAPI_SECURITY_WEP          = 0x1,      /*!< phrase conforms to WEP */
    SCL_NSAPI_SECURITY_WPA          = 0x2,      /*!< phrase conforms to WPA */
    SCL_NSAPI_SECURITY_WPA2         = 0x3,      /*!< phrase conforms to WPA2 */
    SCL_NSAPI_SECURITY_WPA_WPA2     = 0x4,      /*!< phrase conforms to WPA/WPA2 */
    SCL_NSAPI_SECURITY_PAP          = 0x5,      /*!< phrase conforms to PPP authentication context */
    SCL_NSAPI_SECURITY_CHAP         = 0x6,      /*!< phrase conforms to PPP authentication context */
    SCL_NSAPI_SECURITY_EAP_TLS      = 0x7,      /*!< phrase conforms to EAP-TLS */
    SCL_NSAPI_SECURITY_PEAP         = 0x8,      /*!< phrase conforms to PEAP */
    SCL_NSAPI_SECURITY_WPA2_ENT     = 0x9,      /*!< phrase conforms to WPA2-AES and WPA-TKIP with enterprise security */
    SCL_NSAPI_SECURITY_UNKNOWN      = 0xFF,     /*!< unknown/unsupported security in scan results */
} scl_nsapi_security_t;
